...
Deployments may mount Slurm/training logs into the workspace or copy them into `/sandbox/workspace/shared-logs` before the sandbox starts. Search those configured evidence paths before concluding logs are unavailable.
