...
The chart may seed read-only Slurm/training logs into `/home/node/.openclaw/shared-logs` when the original host path is not mounted directly in the sandbox. Search that copied tree before concluding logs are unavailable.
